...
/* DPCT_ORIG         scene->sourceRange =
   make_int2((int)d["sourceRange"][0].GetFloat(),
                                       (int)d["sourceRange"][1].GetFloat());*/
        scene->sourceRange = sycl::int2((int)d["sourceRange"][0].GetFloat(),
                                        (int)d["sourceRange"][1].GetFloat());
        scene->sourceMaxParticleCount = d["sourceMaxParticleCount"].GetInt();

        strcpy(scene->renderFile, d["renderFile"].GetString());
/* DPCT_ORIG         scene->renderRange =
   make_int2((int)d["renderRange"][0].GetFloat(),
                                       (int)d["renderRange"][1].GetFloat());*/
        scene->renderRange = sycl::int2((int)d["renderRange"][0].GetFloat(),
                                        (int)d["renderRange"][1].GetFloat());
...
/* DPCT_ORIG         scene->gridRes = make_int3(d["gridRes"][0].GetInt(),
                                   d["gridRes"][1].GetInt(),
                                   d["gridRes"][2].GetInt());*/
        scene->gridRes =
            sycl::int3(d["gridRes"][0].GetInt(), d["gridRes"][1].GetInt(),
                       d["gridRes"][2].GetInt());
/* DPCT_ORIG         scene->renderRes = make_int2(d["renderRes"][0].GetInt(),
                                     d["renderRes"][1].GetInt());*/
        scene->renderRes =
            sycl::int2(d["renderRes"][0].GetInt(), d["renderRes"][1].GetInt());

/* DPCT_ORIG         scene->domainBboxMin =
   make_float3(d["domainBboxMin"][0].GetFloat(),
                                           d["domainBboxMin"][1].GetFloat(),
                                           d["domainBboxMin"][2].GetFloat());*/
        scene->domainBboxMin = sycl::float3(d["domainBboxMin"][0].GetFloat(),
                                            d["domainBboxMin"][1].GetFloat(),
                                            d["domainBboxMin"][2].GetFloat());
/* DPCT_ORIG         scene->domainBboxMax =
   make_float3(d["domainBboxMax"][0].GetFloat(),
                                           d["domainBboxMax"][1].GetFloat(),
                                           d["domainBboxMax"][2].GetFloat());*/
        scene->domainBboxMax = sycl::float3(d["domainBboxMax"][0].GetFloat(),
                                            d["domainBboxMax"][1].GetFloat(),
                                            d["domainBboxMax"][2].GetFloat());
...
/* DPCT_ORIG         scene->turbMaskTempRamp =
   make_float2(d["turbMaskTempRamp"][0].GetFloat(),
                                              d["turbMaskTempRamp"][1].GetFloat());*/
        scene->turbMaskTempRamp =
            sycl::float2(d["turbMaskTempRamp"][0].GetFloat(),
                         d["turbMaskTempRamp"][1].GetFloat());
/* DPCT_ORIG         scene->turbMaskVelRamp =
   make_float2(d["turbMaskVelRamp"][0].GetFloat(),
                                             d["turbMaskVelRamp"][1].GetFloat());*/
        scene->turbMaskVelRamp =
            sycl::float2(d["turbMaskVelRamp"][0].GetFloat(),
                         d["turbMaskVelRamp"][1].GetFloat());
...
/* DPCT_ORIG             scene->lightDir[i] =
   make_float3(d["lights"][i]["light_dir"][0].GetFloat(),
                                             d["lights"][i]["light_dir"][1].GetFloat(),
                                             d["lights"][i]["light_dir"][2].GetFloat());*/
            scene->lightDir[i] =
                sycl::float3(d["lights"][i]["light_dir"][0].GetFloat(),
                             d["lights"][i]["light_dir"][1].GetFloat(),
                             d["lights"][i]["light_dir"][2].GetFloat());
/* DPCT_ORIG             scene->lightColor[i] =
   make_float3(d["lights"][i]["light_color"][0].GetFloat(),
                                               d["lights"][i]["light_color"][1].GetFloat(),
                                               d["lights"][i]["light_color"][2].GetFloat());*/
            scene->lightColor[i] =
                sycl::float3(d["lights"][i]["light_color"][0].GetFloat(),
                             d["lights"][i]["light_color"][1].GetFloat(),
                             d["lights"][i]["light_color"][2].GetFloat());
        }
...
/* DPCT_ORIG         scene->camU =
   make_float3(d["cam"]["rotMat"][0][0].GetFloat(),
                                  d["cam"]["rotMat"][0][1].GetFloat(),
                                  d["cam"]["rotMat"][0][2].GetFloat());*/
        scene->camU = sycl::float3(d["cam"]["rotMat"][0][0].GetFloat(),
                                   d["cam"]["rotMat"][0][1].GetFloat(),
                                   d["cam"]["rotMat"][0][2].GetFloat());
/* DPCT_ORIG         scene->camV =
   make_float3(d["cam"]["rotMat"][1][0].GetFloat(),
                                  d["cam"]["rotMat"][1][1].GetFloat(),
                                  d["cam"]["rotMat"][1][2].GetFloat());*/
        scene->camV = sycl::float3(d["cam"]["rotMat"][1][0].GetFloat(),
                                   d["cam"]["rotMat"][1][1].GetFloat(),
                                   d["cam"]["rotMat"][1][2].GetFloat());
/* DPCT_ORIG         scene->camW =
   make_float3(d["cam"]["rotMat"][2][0].GetFloat(),
                                  d["cam"]["rotMat"][2][1].GetFloat(),
                                  d["cam"]["rotMat"][2][2].GetFloat());*/
        scene->camW = sycl::float3(d["cam"]["rotMat"][2][0].GetFloat(),
                                   d["cam"]["rotMat"][2][1].GetFloat(),
                                   d["cam"]["rotMat"][2][2].GetFloat());
/* DPCT_ORIG         scene->camTrans = make_float3(d["cam"]["t"][0].GetFloat(),
                                      d["cam"]["t"][1].GetFloat(),
                                      d["cam"]["t"][2].GetFloat());*/
        scene->camTrans = sycl::float3(d["cam"]["t"][0].GetFloat(),
                                       d["cam"]["t"][1].GetFloat(),
                                       d["cam"]["t"][2].GetFloat());
...
/* DPCT_ORIG         scene->shaderVolumeColor =
   make_float3(d["volumeColor"][0].GetFloat(), d["volumeColor"][1].GetFloat(),
                                         d["volumeColor"][2].GetFloat());*/
        scene->shaderVolumeColor = sycl::float3(d["volumeColor"][0].GetFloat(),
                                                d["volumeColor"][1].GetFloat(),
                                                d["volumeColor"][2].GetFloat());
/* DPCT_ORIG         scene->shaderScattering =
   make_float3(d["scatteringColor"][0].GetFloat(),
                                        d["scatteringColor"][1].GetFloat(),
                                        d["scatteringColor"][2].GetFloat());*/
        scene->shaderScattering =
            sycl::float3(d["scatteringColor"][0].GetFloat(),
                         d["scatteringColor"][1].GetFloat(),
                         d["scatteringColor"][2].GetFloat());
...
/* DPCT_ORIG         scene->shaderTempRange =
   make_float2(d["shaderTempRange"][0].GetFloat(),
                                             d["shaderTempRange"][1].GetFloat());*/
        scene->shaderTempRange =
            sycl::float2(d["shaderTempRange"][0].GetFloat(),
                         d["shaderTempRange"][1].GetFloat());
        for (int i=0; i<scene->shaderTempRampSize; i++) {
            scene->shaderColorRampKeys[i] = d["shaderColorRamp"]["keys"][i].GetFloat();
/* DPCT_ORIG             scene->shaderColorRampColors[i] =
   make_float3(d["shaderColorRamp"]["colors"][i][0].GetFloat(),
                                                          d["shaderColorRamp"]["colors"][i][1].GetFloat(),
                                                          d["shaderColorRamp"]["colors"][i][2].GetFloat());*/
            scene->shaderColorRampColors[i] =
                sycl::float3(d["shaderColorRamp"]["colors"][i][0].GetFloat(),
                             d["shaderColorRamp"]["colors"][i][1].GetFloat(),
                             d["shaderColorRamp"]["colors"][i][2].GetFloat());
        }

        scene->multiScatterScale = d["multiScatterScale"].GetFloat();
/* DPCT_ORIG         scene->multiScatterDensityMask = make_float2(
   d["multiScatterDensityMask"][0].GetFloat(),
                                                      d["multiScatterDensityMask"][1].GetFloat()
   );*/
        scene->multiScatterDensityMask =
            sycl::float2(d["multiScatterDensityMask"][0].GetFloat(),
                         d["multiScatterDensityMask"][1].GetFloat());
/* DPCT_ORIG         scene->multiScatterColor = make_float3(
   d["multiScatterColor"][0].GetFloat(), d["multiScatterColor"][1].GetFloat(),
                                                d["multiScatterColor"][2].GetFloat()
   );*/
        scene->multiScatterColor =
            sycl::float3(d["multiScatterColor"][0].GetFloat(),
...
/* DPCT_ORIG     static void sourceParticleParse(const SceneSettings *scn,
 * float3 *posArray,*/
    static void sourceParticleParse(const SceneSettings *scn,
                                    sycl::float3 *posArray,
                                    /* DPCT_ORIG float3 *velArray, float
                                       *pscaleArray, float *tempArray,*/
                                    sycl::float3 *velArray, float *pscaleArray,
                                    float *tempArray, int &pointCount,
                                    int frameNum)
    {
...
/* DPCT_ORIG             posArray[i] = make_float3(array[0],
                                      array[1],
                                      array[2]);*/
            posArray[i] = sycl::float3(array[0], array[1], array[2]);
/* DPCT_ORIG             velArray[i] = make_float3(array[3],
                                      array[4],
                                      array[5]);*/
            velArray[i] = sycl::float3(array[3], array[4], array[5]);
