...
/* DPCT_ORIG #ifdef __DRIVER_TYPES_H__*/
#ifdef __DPCT_HPP__
/* DPCT_ORIG static const char *_cudaGetErrorEnum(cudaError_t error) {*/
static const char *_cudaGetErrorEnum(dpct::err0 error) {
/* DPCT_ORIG   return cudaGetErrorName(error);*/
  /*
  DPCT1009:26: SYCL uses exceptions to report errors and does not use the error
...
#ifdef CURAND_H_
// cuRAND API errors
/* DPCT_ORIG static const char *_cudaGetErrorEnum(curandStatus_t error) {*/
static const char *_cudaGetErrorEnum(int error) {
  switch (error) {
/* DPCT_ORIG     case CURAND_STATUS_SUCCESS:*/
    case 0:
      return "CURAND_STATUS_SUCCESS";

/* DPCT_ORIG     case CURAND_STATUS_VERSION_MISMATCH:*/
    case 100:
      return "CURAND_STATUS_VERSION_MISMATCH";

/* DPCT_ORIG     case CURAND_STATUS_NOT_INITIALIZED:*/
    case 101:
      return "CURAND_STATUS_NOT_INITIALIZED";

/* DPCT_ORIG     case CURAND_STATUS_ALLOCATION_FAILED:*/
    case 102:
      return "CURAND_STATUS_ALLOCATION_FAILED";

/* DPCT_ORIG     case CURAND_STATUS_TYPE_ERROR:*/
    case 103:
      return "CURAND_STATUS_TYPE_ERROR";

/* DPCT_ORIG     case CURAND_STATUS_OUT_OF_RANGE:*/
    case 104:
      return "CURAND_STATUS_OUT_OF_RANGE";

/* DPCT_ORIG     case CURAND_STATUS_LENGTH_NOT_MULTIPLE:*/
    case 105:
      return "CURAND_STATUS_LENGTH_NOT_MULTIPLE";

/* DPCT_ORIG     case CURAND_STATUS_DOUBLE_PRECISION_REQUIRED:*/
    case 106:
      return "CURAND_STATUS_DOUBLE_PRECISION_REQUIRED";

/* DPCT_ORIG     case CURAND_STATUS_LAUNCH_FAILURE:*/
    case 201:
      return "CURAND_STATUS_LAUNCH_FAILURE";

/* DPCT_ORIG     case CURAND_STATUS_PREEXISTING_FAILURE:*/
    case 202:
      return "CURAND_STATUS_PREEXISTING_FAILURE";

/* DPCT_ORIG     case CURAND_STATUS_INITIALIZATION_FAILED:*/
    case 203:
      return "CURAND_STATUS_INITIALIZATION_FAILED";

/* DPCT_ORIG     case CURAND_STATUS_ARCH_MISMATCH:*/
    case 204:
      return "CURAND_STATUS_ARCH_MISMATCH";

/* DPCT_ORIG     case CURAND_STATUS_INTERNAL_ERROR:*/
    case 999:
...
#ifdef __DPCT_HPP__
#ifndef DEVICE_RESET
/* DPCT_ORIG #define DEVICE_RESET cudaDeviceReset();*/
...
/* DPCT_ORIG   cudaError_t err = cudaGetLastError();*/
  /*
  DPCT1010:27: SYCL uses exceptions to report errors and does not use the error
...
inline int _ConvertSMVer2Cores(int major, int minor) {
  ...
  // the # of cores per SM
  typedef struct dpct_type_721633 {
...
/* DPCT_ORIG #ifdef __CUDA_RUNTIME_H__*/
#ifdef __DPCT_HPP__
// General GPU Device CUDA Initialization
inline int gpuDeviceInit(int devID) {
  int device_count;
/* DPCT_ORIG   checkCudaErrors(cudaGetDeviceCount(&device_count));*/
  /*
...
/* DPCT_ORIG   checkCudaErrors(cudaGetDeviceProperties(&deviceProp, devID));*/
  /*
...
/* DPCT_ORIG   if (deviceProp.computeMode == cudaComputeModeProhibited) {*/
  /*
  DPCT1035:33: All SYCL devices can be used by the host to submit tasks. You may
...
/* DPCT_ORIG   if (deviceProp.major < 1) {*/
  /*
...
/* DPCT_ORIG   checkCudaErrors(cudaSetDevice(devID));*/
  /*
  DPCT1093:35: The "devID" device may be not the one intended for use. Adjust
...
/* DPCT_ORIG   printf("gpuDeviceInit() CUDA Device [%d]: \"%s\n", devID,
 * deviceProp.name);*/
...
/* DPCT_ORIG     cudaGetDeviceProperties(&deviceProp, current_device);*/
...
/* DPCT_ORIG       if (deviceProp.major == 9999 && deviceProp.minor == 9999) {*/
      /*
      DPCT1005:39: The SYCL device version is different from CUDA Compute
      Compatibility. You may need to rewrite this code.
      */
      if (deviceProp.get_major_version() == 9999 &&
        ...
        sm_per_multiproc =
            /* DPCT_ORIG             _ConvertSMVer2Cores(deviceProp.major,
               deviceProp.minor);*/
            /*
...
/* DPCT_ORIG       uint64_t compute_perf =
 * (uint64_t)deviceProp.multiProcessorCount **/
      uint64_t
          compute_perf = (uint64_t)deviceProp.get_max_compute_units() *
                         /* DPCT_ORIG sm_per_multiproc * deviceProp.clockRate;*/
                         sm_per_multiproc *
...
/* DPCT_ORIG     checkCudaErrors(cudaSetDevice(devID));*/
    /*
    DPCT1093:41: The "devID" device may be not the one intended for use. Adjust
    the selected device if needed.
    */
    /*
...
/* DPCT_ORIG     checkCudaErrors(cudaGetDeviceProperties(&deviceProp, devID));*/
    ...
    */
    ...
    printf("GPU Device %d: \"%s\" with compute capability %d.%d\n\n", devID,
           /* DPCT_ORIG            deviceProp.name, deviceProp.major,
              deviceProp.minor);*/
           /*
...
/* DPCT_ORIG     if (deviceProp.integrated &&*/
    /*
    DPCT1006:46: SYCL does not provide a standard API to differentiate between
    integrated and discrete GPU devices.
    */
    if (deviceProp.get_integrated() &&
        /* DPCT_ORIG         (deviceProp.computeMode !=
           cudaComputeModeProhibited)) {*/
        /*
        DPCT1035:47: All SYCL devices can be used by the host to submit tasks.
        You may need to adjust this code.
        */
        (true)) {
/* DPCT_ORIG       checkCudaErrors(cudaSetDevice(current_device));*/
      /*
      DPCT1093:48: The "current_device" device may be not the one intended for
...
/* DPCT_ORIG       checkCudaErrors(cudaGetDeviceProperties(&deviceProp,
 * current_device));*/
      /*
      ...
      */
      checkCudaErrors((dpct::dev_mgr::instance()
                       ...
                       0));
      printf("GPU Device %d: \"%s\" with compute capability %d.%d\n\n",
             /* DPCT_ORIG              current_device, deviceProp.name,
                deviceProp.major,*/
             /*
             DPCT1005:51: The SYCL device version is different from CUDA Compute
             Compatibility. You may need to rewrite this code.
             */
             current_device, deviceProp.get_name(),
             deviceProp.get_major_version(),
             /* DPCT_ORIG              deviceProp.minor);*/
             /*
...
/* DPCT_ORIG   checkCudaErrors(cudaGetDevice(&dev));*/
  checkCudaErrors(dev = dpct::dev_mgr::instance().current_device_id());
/* DPCT_ORIG   checkCudaErrors(cudaGetDeviceProperties(&deviceProp, dev));*/
  /*
...
/* DPCT_ORIG   if ((deviceProp.major > major_version) ||*/
  /*
  DPCT1005:56: The SYCL device version is different from CUDA Compute
  Compatibility. You may need to rewrite this code.
  */
  if ((deviceProp.get_major_version() > major_version) ||
      /* DPCT_ORIG       (deviceProp.major == major_version &&*/
      /*
      DPCT1005:57: The SYCL device version is different from CUDA Compute
      Compatibility. You may need to rewrite this code.
      */
      (deviceProp.get_major_version() == major_version &&
       /* DPCT_ORIG        deviceProp.minor >= minor_version)) {*/
       /*
